        ...
        <div className="h-[95vh] sm:h-[84vh] overflow-clip flex items-center">
            ...
            <div className="flex flex-col justify-center left-[2%] absolute mb-8">
                <h1 ref={titleRef}
                    ...
                    FULL STACK</h1>
                <h1 ref={nameRef}
                    className="sm:mb-16 mb-8 sm:text-5xl text-2xl sm:text-left text-center font-bold font-ocean text-slate-100">PELLERIN
                    Aimery</h1>
                <p className="sm:w-[40%] text-slate-200 text-xl">Au fil des années, j'ai développé un véritable intérêt
